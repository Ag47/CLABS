...
public class CardActivity extends ActionBarActivity implements WisePosControllerListener{
...
//        getMenuInflater().inflate(R.menu.menu_start, menu);
    ...
    @Override
    public void onReturnTransactionResult(TransactionResult transactionResult, Hashtable<String, String> hashtable) {
    ...
    @Override
    public void onReturnMagStripeCardNumber(CheckCardResult checkCardResult, String s) {
